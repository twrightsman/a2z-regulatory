...
DanQ [@doi:10.1093/nar/gkw226] is a recurrent CNN that has already been shown to be able to more accurately predict a number of genomic labels, including chromatin accessibility, in the human genome than standard CNNs like DeepSEA [@doi:10.1038/nmeth.3547].
